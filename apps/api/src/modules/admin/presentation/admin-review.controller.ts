...
class FlagReviewDto extends createZodDto(z.object({ reason: z.string().optional() })) {}
...
export class AdminReviewController {
  ...
  flag(@Param() params: ReviewIdParamsDto, @Body() dto: FlagReviewDto, @Req() req: AuthedRequest) {
